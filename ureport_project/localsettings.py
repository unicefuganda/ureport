...
OPT_OUT_WORDS = ["quit","stop","unjoin","giki"]
...
DATABASES = {
    'default': {
        ...
        'HOST': 'db.ureport.org',
        'USER': 'postgres',
	'ROUTER_URL':'http://kannel.ureport.org:13013/cgi-bin/sendsms?from=0000&username=user&password=pwd&text=%(text)s&to=%(recipient)s&smsc=%(backend)s',
#	'OPTIONS': {
 #     	'autocommit': True,
  # 	},
 },
...
YES_WORDS = {"en":["yes","ya","y","yep"]}


NO_WORDS = {"en":["no","nope","nah","n"]}
